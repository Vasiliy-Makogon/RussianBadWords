...
```
Класс умеет обнаруживать слова, где русские буквы заменены на похожие английские (например, "с" на "c", "а" на "a").
Пример для слова "сок": будут созданы варианты "cок", "сok".
Таким образом, система сможет обнаружить запрещённые слова, даже если в них заменены некоторые буквы на похожие английские.
